...
frozen = media.Movie("Frozen","Cold weather and talking snowmen.", "https://upload.wikimedia.org/wikipedia/en/thumb/0/05/Frozen_%282013_film%29_poster.jpg/220px-Frozen_%282013_film%29_poster.jpg", "https://www.youtube.com/watch?v=Zb5IH57SorQ")
#print(frozen.title)

gotg2 = media.Movie("Guardians of the Galaxy 2", "Cool space fights and a dope baby tree.","http://i.annihil.us/u/prod/marvel/html_pages_assets/gotg2-premiere/images/master_gotg2-b3de7b1c93.jpg","https://www.youtube.com/watch?v=z_p3OEpeviM")
#print(gotg2.title)
